...
if(theForm.sdate.value=="")
{
    ...
    return false; 
        ...
        return true;
         ...
         function currencyvalidate() {
             textbox=document.getElementById('pay1');
              if(textbox.disabled)
    {
    ...
    return true
        ...
        var currency = document.getElementById("pay1").value;
        var pattern = /^\d+(?:\.\d{0,2})$/ ;
        if (pattern.test(currency)) {
            ...
            document.form1.mobnum.value.length != 10 || document.form1.phone1.value.length!=10)
            {
                    ...
                    for(j=0;j<txt.length;j++){ //Will look through the value of text
                        ...
                        if(!found){
                            ...
                            document.getElementById('mobnum').value = char.substring(0, char.length -25);
                             document.getElementById('pay1').value = char.substring(0, char.length -25);
...
<body>
   <form name="form1" id="form1" action="update.jsp" method="post" onsubmit="return validateForm(this)&& mobvalidate()&&currencyvalidate();" >
   <div id="wrapper">
  ...
  %>
   ...
   <p>
    	    ...
    	    <input type="text" name="id" size="50"value="<%=id%>" readonly > 
             ...
             <p>   <label for="Name"><span style="font-weight:bold"><em style="color:red">*</em>Name &nbsp;</span></label>
                <input type="text" name="name" size="50"  value="<%=name%>" >
              </p>
   
   <p><label for="Phone"><span style="font-weight:bold"><em style="color:red">*</em>Phone</span></label> 
    	       <input type="text" name="phone" id="phone1"value="<%=phone%>"size="50"onkeyup="isValidChar(this.value);" > 
    	       </p>
               
               <p><label for="Emailid"><span style="font-weight:bold"><em style="color:red">*</em>Emailid</span></label>
    	         <input type="email" name="email" value="<%=email%>"size="50" > 
	         </p>
<p>..............................................................................................................................................................................</p>
       
  <p><label for="UserName"><span style="font-weight:bold"><em style="color:red">*</em>UserName</span></label>
                <input type="text" name="user" value="<%=user%>" size="50"  >
              </p>
              
              
               <p>   <label for="Password"><span style="font-weight:bold"><em style="color:red">*</em>Password</span></label> 
...
<p>
    ...
    document.getElementById('check3').checked=false;
     ...
     <input type=email name="emailid"id="emailid"size="45" value="<%=emailid%>" >
    ...
    var x=<%=emailser%>
     ...
     <input type=tel name="mobnum"id="mobnum" value="<%=mobnum%>" size="45" required onkeyup="isValidChar(this.value);">
...
<p><label for="StartDate"><span style="font-weight:bold"><em style="color:red">*</em>StartDate</span></label> 
                     <input type="text" name="sdate" maxlength="25" size="25"id="demo2" value="<%=s3%>"><a href="javascript:NewCal('demo2','ddmmmyyyy',true,24)"><img src="cal.gif" width="16" height="16" border="0" alt="Pick a date" ></a>
                 </p>
                 
                 
                 
                 <p ><label for="ExpireDate"><span style="font-weight:bold">ExpireDate</span></label> 
                     <input type="Text" id="demo1" name="edate"maxlength="25" size="25" value="<%=s4%>"><a href="javascript:NewCal('demo1','ddmmmyyyy',true,24)"><img src="cal.gif" width="16" height="16" border="0" alt="Pick a date" ></a>
                 </p>
